<#assign
	...
	display_total_items_quantity_in_cart = getterUtil.getBoolean(themeDisplay.getThemeSetting("display-total-items-count-in-mini-cart"))
    ...
    show_dockbar = is_omniadmin || is_group_admin
/>
